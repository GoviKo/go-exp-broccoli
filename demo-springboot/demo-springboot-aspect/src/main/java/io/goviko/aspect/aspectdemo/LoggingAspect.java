...
public class LoggingAspect {
    ...
    @Before("execution(* io.goviko.aspect.aspectdemo.service.*.*(..))")
    ...
    @AfterReturning("execution(* io.goviko.aspect.aspectdemo.service.*.*(..))")
    public void logAfterMethodExecution(JoinPoint joinPoint) {
        logger.info("Exiting method: " + joinPoint.getSignature().getName());
    }

    @AfterThrowing(pointcut = "execution(* io.goviko.aspect.aspectdemo.service.*.*(..))", throwing = "error")
    ...
    @Around("execution(* io.goviko.aspect.aspectdemo.service.*.*(..))")
